...
validate_and_decrypt = function(saml_response, apc_private_keys, idp_certificates, allow_unencrypted, ignore_signature, require_session_index, ignore_timing, notbefore_skew, audience_allowed, ignore_audiences, cb) {
  ...
  return async.waterfall([
    function(cb_wf) {
      ...
      console.log("VALIDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADO")
      ...
      console.log("----------------------------------------------------")
        ...
        var assertion_certificate = xpath.select("//*[local-name(.)='Signature']/*[local-name(.)='KeyInfo']/*[local-name(.)='X509Data']/*[local-name(.)='X509Certificate']", decrypted_assertion_dom)[0].childNodes[0].nodeValue;
        ...
        if (conditions != null) {
          if (ignore_timing !== true) {
            ...
            for (j = 0, len = ref3.length; j < len; j++) {
              ...
              console.log('decrypted_assertion_dom', condition, Date.parse(attribute.value),Date.now());
  ...
  APConnector.prototype._encrypt_response = function(identity_provider, options, cb) {
    ...
    return async.waterfall([
      function(cb_wf) {
        ...
        console.log('SIGNED', signed_assertion);
